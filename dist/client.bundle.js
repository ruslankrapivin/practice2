...
/* harmony import */ var _modules_Popups__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/Popups */ "./front-end/client/js/modules/Popups.js");
/* harmony import */ var _modules_Forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/Forms */ "./front-end/client/js/modules/Forms.js");
/* harmony import */ var _modules_Navigation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/Navigation */ "./front-end/client/js/modules/Navigation.js");
/* harmony import */ var _modules_PortfolioMedia__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/PortfolioMedia */ "./front-end/client/js/modules/PortfolioMedia.js");
...
function () {
  function Root() {
    ...
    this.modules = {
      navigation: new _modules_Navigation__WEBPACK_IMPORTED_MODULE_2__["default"]('.parent-link', '.header', '.mobile-parent-link', '.mobile-menu-button'),
      portfolioMedia: new _modules_PortfolioMedia__WEBPACK_IMPORTED_MODULE_3__["default"](),
      forms: new _modules_Forms__WEBPACK_IMPORTED_MODULE_1__["default"]('.ajax-form'),
      popups: new _modules_Popups__WEBPACK_IMPORTED_MODULE_0__["default"]()
    };
  }
  ...
  _createClass(Root, [{
    ...
    value: function start() {
      var self = this;
      Object.keys(self.modules).forEach(function (module) {
...
/***/ "./front-end/client/js/modules/Forms.js":
/*!**********************************************!*\
  !*** ./front-end/client/js/modules/Forms.js ***!
  \**********************************************/
...
function () {
  ...
  _createClass(Forms, [{
    key: "setPhoneMasks",
    value: function setPhoneMasks(forms) {
      forms.forEach(function (form) {
        ...
        phoneInputs.forEach(function (phoneInput) {
          var maskOptions = {
            ...
            blocks: {
              Y: {
                mask: imask__WEBPACK_IMPORTED_MODULE_0___default.a.MaskedRange,
                from: 0,
                to: 0
              }
            }
          };
          new imask__WEBPACK_IMPORTED_MODULE_0___default.a(phoneInput, maskOptions);
        });
      });
    }
  }, {
    key: "handleSubmit",
    value: function handleSubmit(forms) {
      forms.forEach(function (form) {
...
/***/ "./front-end/client/js/modules/Navigation.js":
/*!***************************************************!*\
  !*** ./front-end/client/js/modules/Navigation.js ***!
  \***************************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function () {
  function Navigation(linksSelector, headerSelector, mobileLinks, mobileButton) {
  ...
  _createClass(Navigation, [{
    ...
    key: "foldHeader",
    value: function foldHeader(links, header) {
      links.forEach(function (link) {
        link.addEventListener('click', function (e) {
          e.preventDefault();
          var linksRows = document.querySelectorAll('.links-row');
          linksRows.forEach(function (row) {
    ...
    key: "headerState",
    value: function headerState(header) {
      if (!header) return;
      var events = ['scroll', 'DOMContentLoaded'];
    ...
    value: function mobileNavigation(links, header, mobileButton) {
      mobileButton.addEventListener('click', function () {
        mobileButton.classList.toggle('active');
        header.classList.toggle('open');
        var linksRows = document.querySelectorAll('.mobile-dropdown');
        linksRows.forEach(function (row) {
      ...
      links.forEach(function (link) {
        link.addEventListener('click', function (e) {
          e.preventDefault();
          var linksRows = document.querySelectorAll('.mobile-dropdown');
          links.forEach(function (inactiveLink) {
...
/***/ "./front-end/client/js/modules/Popups.js":
/*!***********************************************!*\
  !*** ./front-end/client/js/modules/Popups.js ***!
  \***********************************************/
/*! exports provided: default */
...
/***/ "./front-end/client/js/modules/PortfolioMedia.js":
/*!*******************************************************!*\
  !*** ./front-end/client/js/modules/PortfolioMedia.js ***!
  \*******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PortfolioMedia; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/***/ "./front-end/client/scss/style.scss":
/*!******************************************!*\
  !*** ./front-end/client/scss/style.scss ***!
  \******************************************/
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../webpack/node_modules/node-libs-browser/node_modules/process/browser.js */ "./node_modules/webpack/node_modules/node-libs-browser/node_modules/process/browser.js")))
...
/***/ 0:
/*!*****************************************************************************!*\
  !*** multi ./front-end/client/js/app.js ./front-end/client/scss/style.scss ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./front-end/client/js/app.js */"./front-end/client/js/app.js");
module.exports = __webpack_require__(/*! ./front-end/client/scss/style.scss */"./front-end/client/scss/style.scss");
